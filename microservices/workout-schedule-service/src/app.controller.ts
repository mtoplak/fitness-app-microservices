...
export class AppController {
  ...
  @ApiQuery({ name: 'type', required: false, description: 'Filter by workout type' })
  @ApiResponse({ status: 200, description: 'List of schedules', type: [ScheduleResponseDto] })
  async getSchedules(
  ...
  @ApiOperation({ summary: 'Propose a new schedule (trainer, pending approval)' })
  @ApiResponse({ status: 201, description: 'Schedule proposal created', type: ScheduleResponseDto })
  @ApiResponse({ status: 400, description: 'Invalid input' })
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiResponse({ status: 200, description: 'Conflict check result', type: ConflictCheckDto })
  async checkConflict(
  ...
  @ApiResponse({ status: 200, description: 'List of pending schedules', type: [ScheduleResponseDto] })
  ...
  @ApiParam({ name: 'id', description: 'Schedule ID' })
  @ApiResponse({ status: 200, description: 'Schedule approved', type: ScheduleResponseDto })
  @ApiResponse({ status: 404, description: 'Schedule not found' })
  ...
  @ApiParam({ name: 'id', description: 'Schedule ID' })
  @ApiResponse({ status: 200, description: 'Schedule rejected', type: ScheduleResponseDto })
  @ApiResponse({ status: 404, description: 'Schedule not found' })
  ...
  @ApiParam({ name: 'id', description: 'Schedule ID' })
  @ApiResponse({ status: 200, description: 'Schedule cancelled', type: ScheduleResponseDto })
  @ApiResponse({ status: 404, description: 'Schedule not found' })
